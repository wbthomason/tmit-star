(define (problem shelves_pb_12)
 (:domain shelves)
 (:objects
  r_gripper_tool_joint -manipulator
  blue_stick_1 green_stick_1 red_stick_1 red_stick_2 red_stick_3 red_stick_4 red_stick_5 red_stick_6 red_stick_7 red_stick_8 red_stick_9 red_stick_10 -objs)
 (:init
