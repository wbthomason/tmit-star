(define (problem clutter_pb_12)
 (:domain clutter)
 (:objects
  table_1 table_2 table_3 table_4 -surface
  l_gripper_tool_joint r_gripper_tool_joint -manipulator
  blue_stick_1 blue_stick_2 blue_stick_3 blue_stick_4 blue_stick_5 blue_stick_6 green_stick_1 green_stick_2 green_stick_3 green_stick_4 green_stick_5 green_stick_6 -objs )
 (:init
